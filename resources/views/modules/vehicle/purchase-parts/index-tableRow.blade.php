<tr class="table-row content align-middle">
  ...
  <td class="vehicle-number">{{ $purchase->vehicle_id }}</td>
  <td class="parts-list">{{ $purchase->vehicle_id }}</td>
  ...
  <td class="purchased-by">{{ $purchase->purchased_by }}</td>
  <td class="authorized-by">{{ $purchase->authorized_by }}</td>
